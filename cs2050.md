...
---------------------------------------------------------------------
Conclusion: Since we have shown the base step and inductive step to be true, then by the principle of Mathematic Induction we have shown that P(n) is true for all n ∈ Z, n >= 4.
```
...
Conclusion: Since we have shown both the base case and inductive step are true by the principle of mathematical induction P(n) is true for all n ∈ Z+.
```
