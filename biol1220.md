...
9.13.18 | [Ecosystems](#ecosystems)
9.20.18 | [Sexual Reproduction](#sexual-reproduction)
10.25.18 | [Genetically Modified Organisms (and Molecular Cloning)](#genetically-modified-organisms)
10.30.18 | [Homosexuality](#homosexuality)
11.1.18 | [Why do organisms age?](#why-do-organisms-age)
11.8.18 | [Infection](#infection)
11.15.18 | [Immune Response](#immune-response)
...
Symbiosis | + | -
 ...
 ---
 ## Ecosystems
 All have a pyramid of productivity, in which energy is lost between trophic levels (from heat, work to keep the organism alive, inefficiency of being an organism - e.g. poop, we do not convert everything we eat to biomass)
- population sizes are bigger for lower trophic levels, smaller individuals in lower levels
- energy loss sets a fundamental limit on the number of trophic levels
- reproduction rates in lower trophic levels are higher

**trophic cascades** - when changes at one trophic level cuases change at other trophic levels  
**bioaccumulation** - when a chemical that cannot be processed is introduced at a lower trophic level

---
## Sexual Reproduction

### How do we characterize sex?
- physical characteristics
- chromosomes 

A haploid with two chromatids is a **homologous pair**. 

### Meiosis
- Produce gametes with just half the parents' genetic material. Gametes are haploid.
- 4 haploid cells from 1 diploid cell

---
**Biological Fitness** - ability to produce successful offspring *relative to others in the population*

Females are more likely to be "choosy".
- The sex that invests more is limted by access to resources
- the sex that invests less is limited by ability to mate with the sex that invests more

### Parental Investment
Any form of investment that increases' offspring's chnce of survival at the expense of the parent's ability to invest in other offspring.

---
## Genetically Modified Organisms
Or more scientifically, transgenic organisms. 

### Bt Gene
*Bacillus thuringiensis* - soil bacterium which makes a Cry protein, which is toxic to insexts by lysing the midgut  
Bt toxin gene is inserted into the DNA of a plant, like corn. 
- Bt makes a variety of cry proteins, which are specific to the different insect groups that feed on it
- each cry toxin activates at a certain pH, which then binds to protein receptors in the insect midgut

*Agrobacterium* is used to insert a transgene (creates a pilus-like structure to insert plasmid into plant cell).  
Or you can be old school, and use a "gene gun," which shoots gold particles with DNA towards the cell and hope for the best.

---
## Homosexuality
A preference for same sex partners / matings.

### Evolutionary Benefits
- practice mating rituals / copulation
- competition for mates, using sex and intimidation
- social reward (Bonobos)
- establish alpha/beta social rank

### Genetic Studies
- fruitless controls courtship behavior in fruit flies
- X<sub>q</sub>28

---
## Why do organisms age?
### Factors
- diet, behavior, disease, lifestyle, genetics, socio-economic status

### Biological Fitness
= survival + reproduction

Evolution by natural selection *should* maximize fitness by shaping a life history with:
- long life, lots of reproductive bouts, lots of kids at each reproduction event

There is a fitness trade-off between survival and reproduction (increase in one life history trait correlates to a decrease in another) due to energy use.

### What is aging (senescense)?
Age-related decline in an organism's ability to survive and reproduce.  
In humans and other organisms, the likelihoods of morbities and mortality increase proportionally with age.

After the age of maturity, selection becomes weaker with increasing age.
...
susceptible ---> infected ---> removed
    S        ^       I            R
             |               (recovered,
       transmission         dead, immune)
           rate
```

### Prediction
- spread
- time to "critical" epidemic
- containment -> quarantine, vaccinate
- account for mortality, reduce mortality

**prevalence** - proportion of individuals infected  
**endemic** - threshold of prevalence where infection will not spread  
**epidemic** (within a population) - when prevalence goes above the endemic threshold  
**pandemic** - epidemic across populations  
**virulence** - severity of infection  
**immunity** - resistance to disease

### Simplifying Assumptions (SI or Humans vs. Zombies)
1. Population size is constant
2. All infected individuals are infectious.
3. All susceptibles have same risk.
4. No latency (get sick immediately), no vectors
5. Transmission is density dependent
6. Recovery rate is constant at 1 / time infected

---
## Immune Response

### Immune System Components (cells + other factors)
COMPONENT | DEFINITION
--- | ---
T-cells (helper / cytotoxic) | have receptors on their surface
B-cells | produce antibodies
phagocytic cells | engulf and digest pathogens
MHC (major histocompatibility) | present pieces of protein from the inside of a cell
macrophage | type of phagocytic cell that also presents antibodies
antibody | proteins that bind to antigens to alert the immune system
antigen | anything that provokes an immune response
pathogen | cause disease

```
     INNATE                CONNECTS              ADAPTIVE
-----------------------------------------------------------
mucus, skin, pus                                  T, B
phagocytic cells        phagocytic cells           MHC
 (macrogphages)   --->   (macrophages)   --->   antibodies
      APC                     APC              memory cells
```

Response         | Activity                    | Component           | Target
---              | ---                         | ---                 | ---
Humoral (fluids) | antibodies bind to antigens | B-cells, antibodies | outside cells
Cell-mediated    | infected cells are killed   | cytotoxic T-cells   | inside cells
